...
public class OvenMenu extends AbstractContainerMenu {
    ...
    public OvenMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.OVEN_MENU.get(), containerId);
        ...
        for (int row = 0; row < 2; ++row) {
            for (int column = 0; column < 3; ++column) {
                this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, (row * 3) + column,
                        inputStartX + (column * borderSlotSize),
                        inputStartY + (row * borderSlotSize)));
            }
        }

        //this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 0,  30, 17));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 7,  124, 26));
